...
func (b *blockingRipExecutor) StartRip(_ context.Context, _ makemkv.Source, _ int, expectSource string, outputDir string, onEvent func(makemkv.Event), _ *makemkv.SelectionOpts) error {
...
func (m *immediateRipExecutor) StartRip(_ context.Context, _ makemkv.Source, _ int, expectSource string, outputDir string, onEvent func(makemkv.Event), _ *makemkv.SelectionOpts) error {
	_ = os.WriteFile(filepath.Join(outputDir, "title.mkv"), []byte("fake"), 0o644)
	if onEvent != nil {
		onEvent(makemkv.Event{Type: "PRGV", Progress: &makemkv.Progress{Current: 65536, Total: 65536, Max: 65536}})
	}
