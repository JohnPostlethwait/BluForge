...
func (m *fullMockExecutor) StartRip(_ context.Context, _ makemkv.Source, _ int, expectSource string, _ string, onEvent func(makemkv.Event), _ *makemkv.SelectionOpts) error {
