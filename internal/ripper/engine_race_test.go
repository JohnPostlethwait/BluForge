...
func (noopRipExecutor) StartRip(_ context.Context, _ makemkv.Source, _ int, expectSource string, _ string, _ func(makemkv.Event), _ *makemkv.SelectionOpts) error {
	return nil
}
