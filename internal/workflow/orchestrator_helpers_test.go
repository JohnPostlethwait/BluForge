...
func (m *mockRipExecutor) StartRip(_ context.Context, _ makemkv.Source, _ int, expectSource string, outputDir string, onEvent func(makemkv.Event), _ *makemkv.SelectionOpts) error {
